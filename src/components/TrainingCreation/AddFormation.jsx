        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-lg-6 grid-margin stretch-card">
              ...
              <div class="col-md-12 miakatra">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="business-tab" data-toggle="tab" href="#session" role="tab" aria-selected="false">Session</a>
                    </li>
                  </ul>
                </div>
                <div class="tab-content tab-transparent-content">
                  <div class="tab-pane fade show active" id="session" role="tabpanel" aria-labelledby="business-tab">
          ...
          <button type="button" class="btn btn-dark btn-fw">Save</button>
        </div>
      </div>
    </div>
  );
