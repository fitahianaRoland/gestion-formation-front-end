...
function Header() {
  ...
  return (
    ...
    <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a className="navbar-brand brand-logo update-logo" href="index.html"><img src="/assets/images/softwelllogo.png" alt="logo" /></a>
      <a className="navbar-brand brand-logo-mini update-logo" href="index.html"><img src="/assets/images/softwelllogo-min3.png" alt="logo" /></a>
    </div>
    <div className="navbar-menu-wrapper d-flex align-items-stretch">
      ...
      <button className="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas" onClick={onBurgerMenuClick}>
        <span className="mdi mdi-menu"></span>
      </button>
    </div>
  </nav>
